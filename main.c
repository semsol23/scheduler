...
int main(int argc, char *argv[]) {
	...
	{	
		fscanf(fp, "%s %s %d %d %d", &name, &place, &type, &month, &day); // Read file through 'fscanf'
		if(feof(fp)) break; // feof function in C language, if the last try is fail return true. So, need here.
